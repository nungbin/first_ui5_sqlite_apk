		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "App Title",
									"targetURL": "#ui5uitemplate1-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"ui5uitemplate1-display": {
								"semanticObject": "ui5uitemplate1",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=ui5uitemplate1",
									"url": sap.ui.require.toUrl("ui5uitemplate1")
								}
							}
						}
					}
